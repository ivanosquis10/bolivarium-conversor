...
describe("HistoryList component", () => {
  ...
  it("Verifica que el historial se muestre correctamente con conversiones", () => {
    ...
    historyFull.forEach((historyItem) => {
      render(<HistoryCard history={historyItem} onCopy={jest.fn()} onDelete={jest.fn()} />)
    })
...
describe("HistoryCard component", () => {
  ...
  it("Verifica si llama a la funcion onCopy", () => {
    ...
    render(<HistoryCard history={historyItem} onCopy={onCopyMock} onDelete={jest.fn()} />)
  ...
  it("Verifica si llama a la funcion onDelete", () => {
    ...
    render(<HistoryCard history={historyItem} onCopy={jest.fn()} onDelete={onDeleteMock} />)
