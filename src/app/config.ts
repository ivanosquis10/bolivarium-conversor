export const config = {
  ...
  meta: {
    ...
    description: 'Descubre Bolivarium, el portal de las divisas que te ofrece información detallada sobre el dólar en Venezuela. Convierte bolívares a dólares y viceversa de manera fácil y precisa. ¡Optimiza tus transacciones con nuestro amigable conversor!',
