...
export const QUESTIONS: FAQuestions[] = [
  {
    ...
    answer: 'A veces sucede que la información de las monedas no esta actualizada del todo, esto aplica más que todo si ya has entrado anteriormente a la aplicación, por eso te recomiendo que por seguridad actualizar la página al entrar.'
  },
  {
    id: 2,
